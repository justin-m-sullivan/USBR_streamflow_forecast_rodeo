...
def main(): 
        ...
        while line:
            if not(line.startswith("#") or line.startswith("agency") or line.startswith("5s")):
                ...
                if len(parts) == 6:
                    ...
                    discharge = parts[4]
                    status = parts[5]
                    estimated = status.startswith("P:e") or status.startswith("A:e")
    ...
    sys.stdout.write("  Number of discarded estimated values: " + str(number_of_estimated_values) + "\n")
    return 0        
